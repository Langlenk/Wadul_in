...
// Pengaduan Admin
Route::get('/admin/pengaduan/masuk', [PengaduanController::class, 'masuk']);
Route::get('/admin/pengaduan/diabaikan', [PengaduanController::class, 'diabaikan']);

// Tanggapan Admin
Route::get('/admin/tanggapan/diproses', [TanggapanController::class, 'diproses']);
Route::get('/admin/tanggapan/selesai', [TanggapanController::class, 'selesai']);
