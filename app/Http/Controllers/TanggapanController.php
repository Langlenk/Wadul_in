...
class TanggapanController extends Controller
{
    ...
    {
        $pengaduan = Pengaduan::where('status', 'proses')->with('masyarakat')->get();
        return view('admin.tanggapan.diproses', compact('pengaduan'));
    }

    public function selesai()
    {
        $pengaduan = Pengaduan::where('status', 'selesai')->with('masyarakat')->get();
        return view('admin.tanggapan.selesai', compact('pengaduan'));
    }
}
