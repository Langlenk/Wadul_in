...
class PengaduanController extends Controller
{
    ...
    public function diabaikan()
    {
        $pengaduan = \App\Models\Pengaduan::where('status', '0')->latest()->get();
        return view('admin.pengaduan.diabaikan', compact('pengaduan'));
    }

     public function masuk()
    {
        $pengaduan = \App\Models\Pengaduan::where('status', '0')->latest()->get();
        return view('admin.pengaduan.masuk', compact('pengaduan'));
    }
