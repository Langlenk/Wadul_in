...
@section('content_admin')
    <div class="row g-4">
        <div class="col-sm-6 col-xl-3">
            <a href="{{ url('/admin/pengaduan/masuk') }}" class="text-decoration-none text-dark">
        ...
        <div class="col-sm-6 col-xl-3">
            <a href="{{ url('/admin/pengaduan/diabaikan') }}" class="text-decoration-none text-dark">
                <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
        ...
        <div class="col-sm-6 col-xl-3">
            <a href="{{ url('/admin/tanggapan/diproses') }}" class="text-decoration-none text-dark">
                <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
        ...
        <div class="col-sm-6 col-xl-3">
            <a href="{{ url('/admin/tanggapan/selesai') }}" class="text-decoration-none text-dark">
                <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
